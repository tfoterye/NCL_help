...
if((tdi)&&(tdi["hasFeature"])&&(tdi.hasFeature("http://www.ncl.ucar.edu/scripts/dojo/org.w3c.dom.svg","1.0"))){
drs.capable=t;
...
dojo.provide("http://www.ncl.ucar.edu/scripts/dojo/dojo.lang.func");
...
dojo.provide("http://www.ncl.ucar.edu/scripts/dojo/dojo.dom");
...
dojo.provide("http://www.ncl.ucar.edu/scripts/dojo/dojo.uri.Uri");
...
dojo.provide("http://www.ncl.ucar.edu/scripts/dojo/dojo.lfx.html");
...
dojo.kwCompoundRequire({browser:["http://www.ncl.ucar.edu/scripts/dojo/dojo.lfx.html"],dashboard:["http://www.ncl.ucar.edu/scripts/dojo/dojo.lfx.html"]});
